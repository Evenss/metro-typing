...
export const DEPARTURE_CHIME_NOTES = Object.freeze([
  Object.freeze({ frequency: 392, delay: 0.03, duration: 0.16, gain: 0.012 }),
  Object.freeze({ frequency: 523.25, delay: 0.22, duration: 0.3, gain: 0.018 }),
  Object.freeze({ frequency: 659.25, delay: 0.48, duration: 0.42, gain: 0.022 }),
]);

export const COMPLETION_CHIME_NOTES = Object.freeze([
  Object.freeze({ frequency: 783.99, delay: 0, duration: 0.24, gain: 0.024 }),
  Object.freeze({ frequency: 987.77, delay: 0.2, duration: 0.26, gain: 0.027 }),
  Object.freeze({ frequency: 1318.51, delay: 0.43, duration: 0.36, gain: 0.03 }),
]);
